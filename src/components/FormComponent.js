...
export default function FormComponent({ data, onClick, button }) {
      ...
      <div className="flex">
        {currentItems &&
          currentItems.map((item) => (
            <div
              className="w-1/5 rounded-lg shadow-md lg:max-w-sm cursor-pointer hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            ...
            >
              <div className="p-4">
                ...
                <div className="flex flex-col items-start ">
                  <p className="mb-2 leading-normal">Reason:</p>
                  <p className="mb-2 leading-normal font-bold">{item.reason}</p>
